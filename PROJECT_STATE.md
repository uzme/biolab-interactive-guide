...
| Oxirgi tasdiqlangan web checkpoint | `df7f1deb` |
| Git commit | GitHub `main` branchida sinxronlash metadata-si bilan qayd etilgan joriy versiya (`0da07be`) |
