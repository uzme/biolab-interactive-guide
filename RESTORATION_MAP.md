...
|---|---|---|---|
| Source code & Docs | [GitHub `uzme/biolab-interactive-guide` repository root](https://github.com/uzme/biolab-interactive-guide/tree/main) | Biotexnologiya yangi Drive root `19um8Y1EuuZbbTR2ncXDeg6mekc_xorhV`; verified snapshot `1q3PT-h_0FOHSoTIRMfQ6IOaRqHYkrgjh` | `gh repo clone` or extract the canonical Drive snapshot |
...
| Equipment Images & Assets | Current BioLab source references and managed static storage | Biotexnologiya yangi Drive root `19um8Y1EuuZbbTR2ncXDeg6mekc_xorhV` | Restore only from the canonical project snapshot; historical asset vaults are read-only and not write destinations |
