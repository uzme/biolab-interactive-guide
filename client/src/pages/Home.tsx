  ...
  return <div className="shell">
    ...
    <main className="app-main min-w-0 flex-1">
      ...
      <div className="page-frame mx-auto max-w-[1500px] px-5 py-6 sm:px-8 sm:py-10 lg:px-12">
        <section className="command-hero soft-grid relative overflow-hidden rounded-[30px] border border-[#245b60] bg-[#0b3941] shadow-[0_25px_60px_rgba(26,76,72,0.18)]">
