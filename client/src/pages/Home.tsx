  ...
  return <div className="shell">
    ...
    <main className="app-main min-w-0 flex-1">
      ...
      <div className="page-frame mx-auto max-w-[1500px] px-5 py-6 sm:px-8 sm:py-10 lg:px-12">
        <section className="command-hero hero-command-deck soft-grid relative overflow-hidden rounded-[30px] border border-[#245b60] bg-[#0b3941] shadow-[0_25px_60px_rgba(26,76,72,0.18)]" data-hero-surface>
          ...
          <div className="hero-command-content relative min-h-[420px] max-w-3xl px-6 py-8 sm:min-h-[425px] sm:px-10 sm:py-14">
            <div className="hero-kicker-row">
              <div className="eyebrow text-[#9fe8d5]">BIO.LAB / QURILMA → SOP → TALQIN</div>
              <span className="hero-kicker-status"><span aria-hidden="true" />LAB-01 FAOL</span>
            </div>
            <h1 className="hero-command-title display max-w-[760px] text-[2.55rem] font-bold leading-[0.96] tracking-[-0.06em] text-[#f7f8ed] md:text-5xl lg:text-7xl">Qurilmani <span className="text-[#7de0c2]">tushuning.</span><br />Keyin ishonch bilan ishlating.</h1>
            <p className="hero-command-copy mt-4 max-w-xl text-sm leading-6 text-[#c6e1d7] sm:mt-6 sm:text-base">100 ta biotexnologiya qurilmasi uchun model, real workflow, natijani talqin qilish va xavfsizlikni bitta izchil o‘quv yo‘lida o‘rganing.</p>
            <div className="hero-command-actions mt-5 flex flex-wrap gap-3 sm:mt-7"><Button className="bg-[#d9f0e5] text-[#075b5d] hover:bg-white" onClick={() => document.getElementById("catalog")?.scrollIntoView({ behavior: "smooth" })}>Katalogni ochish <ArrowUpRight size={16} /></Button><Button variant="outline" className="border-white/30 bg-transparent text-white hover:bg-white/10" onClick={() => setSelectedDevice(equipment[0])}>Namunani ko‘rish <ChevronRight size={16} /></Button></div>
            <div className="hero-learning-path mt-7 max-w-[760px]" data-hero-learning-path aria-label="16 bo‘limli o‘quv yo‘li">
              <div className="hero-learning-path-head"><div><span className="tech-label text-[#a8ead9]">16 BO‘LIMLI O‘QUV YO‘LI</span><p>Qurilmani tushunishdan manbalargacha.</p></div><span className="hero-learning-total">16 <small>QADAM</small></span></div>
              <div className="hero-learning-progress" aria-hidden="true">{Array.from({ length: 16 }, (_, index) => <span key={index} className={index === 0 || index === 4 || index === 8 || index === 15 ? "is-marker" : ""} />)}</div>
              <div className="hero-learning-stages" role="list"><div role="listitem"><b>01</b><span>Tushuncha</span></div><div role="listitem"><b>05</b><span>Prinsip</span></div><div role="listitem"><b>09</b><span>Workflow</span></div><div role="listitem"><b>16</b><span>Manbalar</span></div></div>
            </div>
          </div>
          <div className="hero-record-panel absolute right-7 top-7 hidden w-[250px] overflow-hidden rounded-2xl border border-[#9ce5d3]/25 bg-[#082f35]/80 text-[#d1f1e6] shadow-2xl backdrop-blur-md lg:block"><div className="border-b border-white/10 px-4 py-3"><div className="tech-label text-[#9fe8d5]">BIO.LAB // LAB-01</div><div className="mt-2 text-lg font-bold tracking-[-0.03em] text-white">Ilmiy rekord → amaliyot</div></div><div className="grid grid-cols-2 gap-px bg-white/10"><div className="bg-[#0b454d] px-4 py-4"><div className="metric-number text-3xl font-bold text-[#d9f0e5]">100</div><div className="mt-1 text-[9px] font-bold uppercase tracking-[0.14em] text-[#9fe8d5]">Qurilma</div></div><div className="bg-[#0b454d] px-4 py-4"><div className="metric-number text-3xl font-bold text-[#d9f0e5]">16</div><div className="mt-1 text-[9px] font-bold uppercase tracking-[0.14em] text-[#9fe8d5]">SOP qadam</div></div></div><div className="space-y-2 px-4 py-4 text-[11px] leading-5 text-[#c6e5dc]"><div className="flex justify-between border-b border-white/10 pb-2"><span>MODEL</span><span className="text-[#93e0cf]">aniqlanadi</span></div><div className="flex justify-between border-b border-white/10 pb-2"><span>WORKFLOW</span><span className="text-[#93e0cf]">bosqichma-bosqich</span></div><div className="flex justify-between"><span>NATIJA</span><span className="text-[#93e0cf]">talqin qilinadi</span></div></div></div>
        </section>
