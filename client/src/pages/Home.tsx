      ...
      <div className="mx-auto max-w-[1500px] px-5 py-6 sm:px-8 sm:py-10 lg:px-12">
        <section className="soft-grid relative overflow-hidden rounded-[30px] border border-[#245b60] bg-[#0b3941] shadow-[0_25px_60px_rgba(26,76,72,0.18)]">
          ...
          <div className="relative min-h-[425px] max-w-3xl px-6 py-10 sm:px-10 sm:py-14">
            <div className="eyebrow mb-4 text-[#9fe8d5]">LAB-01 • SOP / MANUAL / TALQIN</div>
            ...
            <div className="mt-7 max-w-2xl rounded-2xl border border-[#a6e5d6]/25 bg-[#082f35]/60 p-3.5 backdrop-blur-sm"><div className="mb-3 flex items-center justify-between gap-3"><span className="tech-label text-[#a8ead9]">16-QADAMLI O‘QUV RELSI</span><span className="rounded-full border border-[#93dfcd]/25 bg-[#0b5358] px-2 py-1 text-[9px] font-bold uppercase tracking-[0.15em] text-[#d7f7ed]">Protokol faol</span></div><div className="grid grid-cols-8 gap-1.5 sm:grid-cols-[repeat(16,minmax(0,1fr))]">{curriculumSteps.map((step, index) => <div key={step} className={`rounded-md border px-1 py-1.5 text-center ${index === 0 || index === 4 || index === 8 || index === 15 ? "border-[#81e0c8] bg-[#1b746f] text-white" : "border-white/10 bg-white/[0.045] text-[#bae6d9]"}`}><span className="block text-[9px] font-bold tracking-tight">{step}</span><span className="mx-auto mt-1 block h-0.5 w-3 rounded-full bg-current opacity-70" /></div>)}</div><div className="mt-3 grid grid-cols-4 gap-2 text-[9px] font-bold uppercase tracking-[0.11em] text-[#bfeadd]"><span>01 Tushuncha</span><span>05 Prinsip</span><span>09 Workflow</span><span>16 Manual</span></div></div>
          ...
          <div className="absolute right-7 top-7 hidden w-[250px] overflow-hidden rounded-2xl border border-[#9ce5d3]/25 bg-[#082f35]/80 text-[#d1f1e6] shadow-2xl backdrop-blur-md lg:block"><div className="border-b border-white/10 px-4 py-3"><div className="tech-label text-[#9fe8d5]">BIO.LAB / O‘QUV SIGNALI</div><div className="mt-2 text-lg font-bold tracking-[-0.03em] text-white">Nazariya → amaliyot</div></div><div className="grid grid-cols-2 gap-px bg-white/10"><div className="bg-[#0b454d] px-4 py-4"><div className="metric-number text-3xl font-bold text-[#d9f0e5]">100</div><div className="mt-1 text-[9px] font-bold uppercase tracking-[0.14em] text-[#9fe8d5]">Qurilma</div></div><div className="bg-[#0b454d] px-4 py-4"><div className="metric-number text-3xl font-bold text-[#d9f0e5]">16</div><div className="mt-1 text-[9px] font-bold uppercase tracking-[0.14em] text-[#9fe8d5]">Qadam</div></div></div><div className="space-y-2 px-4 py-4 text-[11px] leading-5 text-[#c6e5dc]"><div className="flex justify-between border-b border-white/10 pb-2"><span>MANUAL</span><span className="text-[#93e0cf]">tekshiriladi</span></div><div className="flex justify-between border-b border-white/10 pb-2"><span>WORKFLOW</span><span className="text-[#93e0cf]">bosqichma-bosqich</span></div><div className="flex justify-between"><span>NATIJA</span><span className="text-[#93e0cf]">talqin qilinadi</span></div></div></div>
        </section>
