...
const welcomeMessage: ChatMessage = {
  id: 1,
  role: "agent",
  text: "Men BioLab Pixel Agentiman. 100 ta qurilma katalogidan model, vazifa, kategoriya va narx bo‘yicha tezkor yo‘l-yo‘riq beraman. Savolingizni yozing yoki namunadan boshlang.",
};
    ...
    <div className="min-h-screen bg-[#031417] text-[#eaf8f0] selection:bg-[#67e2bf]/30">
      <div className="mx-auto min-h-screen max-w-[1180px] px-3 py-3 sm:px-6 sm:py-6 lg:px-10">
        <header className="flex items-center justify-between rounded-[22px] border border-[#2d716c]/50 bg-[#082b30]/90 px-4 py-3 shadow-[0_18px_40px_rgba(0,0,0,0.22)] backdrop-blur-xl sm:px-6">
          ...
          <div className="flex items-center gap-2 rounded-full border border-[#4dbf9d]/35 bg-[#0a4244] px-3 py-2 text-[10px] font-bold uppercase tracking-[0.17em] text-[#9bead4]"><span className="h-2 w-2 animate-pulse rounded-full bg-[#67e2bf] shadow-[0_0_12px_#67e2bf]" /> Local katalog</div>
        </header>
