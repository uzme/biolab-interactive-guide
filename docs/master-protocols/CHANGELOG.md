...
- Sanitised release targets `uzme/biolab-interactive-guide` main branch and `Biotexnologiya` root on Google Drive. Secrets, tokens, API keys, passwords, PATs, `node_modules`, `dist`, and logs remain excluded.
