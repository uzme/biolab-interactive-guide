...
Rolloutdan keyingi `pnpm run check`, production build, Vitest presentation testlari, katalog/rating qidiruv regressiyasi, DeviceViewer mobil regressiyasi va continuity audit muvaffaqiyatli yakunlandi. 390×844 px viewportda katalogning media kontrasti va responsive hero dizayni ko‘zdan kechirildi; regressiya aniqlanmadi. Release sync navbatida barcha o‘zgartirishlar secrets-free snapshot hamda GitHub `main`ga yuboriladi.
