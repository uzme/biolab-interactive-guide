...
assert(await page.getByRole("heading", { name: /BioLab laboratoriya ochilish sahifasi/i }).isVisible(), "Expo Go kirish ekranida BioLab ochilish sarlavhasi ko‘rinmadi.");
